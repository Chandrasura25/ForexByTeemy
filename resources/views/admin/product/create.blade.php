                        ...
                        <div class="p-3">
                            <div>
                                <div class="form-floating mb-2">
                                  <input type="text" class="form-control" id="floatingInput" placeholder="Product Name" required name="name">
                                ...
                                <div class="form-floating mb-2" id="percentageInput">
                                  <input type="number" class="form-control" id="percentage" placeholder="Quantity" name="quantity">
                                ...
                                <div class="form-floating mb-2" id="fixedInput">
                                  <input type="number" class="form-control" id="fixed" placeholder="Price" name="price" required>
                    ...
                    <h2 class="title">Others</h2>
                        <div class="formBx">
                           <div class="p-3">
                                ...
                                <div id="dateInputs">
                                    <div class="form-floating mb-2">
                                        <input type="datetime-local" class="form-control" id="startDate" name="expiration_date">
