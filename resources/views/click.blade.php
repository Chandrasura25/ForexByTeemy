...
@section('content')
    ...
    <div class="Box">
        <div class="title">
            ...
            <p><span>Unlock the power of referrals and earn a certain percenatage!</span><br> Share your unique referral
                code with friends and family, and when they sign up using your code, you both receive a bonus of 30 credits.
                Start referring today and watch your credits grow as you and your loved ones reap the benefits of this
                referral program.</p>
        </div>
            ...
            <div class="ref_link">
                <div class="drop">
                    <div class="content">
                        ...
                        <form action="">
                            <div class="inputBox">
                                <input type="text" name="" value="{{ $myRefLink }}" readonly
                                    placeholder="Referrer Link" id="">
                            </div>
                            <div class="inputBox">
                                <input type="button" id="copyButton" data-clipboard-text="{{ $myRefLink }}"
                                    value='Copy' id="">
                            </div>
                        </form>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actionBx">
                                            ...
                                            <div class="ref_copy">
                                                <input type="button" id="copySourceButton_{{ $loop->iteration }}"
                                                    data-clipboard-text="{{ url('/register/' . $user->username . '-' . $ref->source) }}"
                                                    value='Copy'>
                                                <input type="hidden" id="referrerLink_{{ $loop->iteration }}"
                                                    value="{{ url('/register/' . $user->username . '-' . $ref->source) }}">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var copyButtons = document.querySelectorAll("[id^='copySourceButton_']");

            copyButtons.forEach(function(button) {
                button.addEventListener("click", function() {
                    var iteration = button.id.split("_")[1];
                    var referrerLink = document.getElementById("referrerLink_" + iteration);
                    var copiedText = referrerLink.value.trim();
                    copyToClipboard(copiedText);
                    changeButtonValue(button);
                    removeCopiedText(iteration);
                });
            });
            ...
            function removeCopiedText(iteration) {
                setTimeout(function() {
                    var referrerLink = document.getElementById("referrerLink_" + iteration);
                    referrerLink.value = "";
                }, 60000); // 1 minute
